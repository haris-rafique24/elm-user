...
var $author$project$CounterTests$updateWithEvent = F2(
	function (msg, model) {
		return model + 1;
	});
var $author$project$CounterTests$Increment = {$: 'Increment'};
...
var $author$project$CounterTests$viewWithModel = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Events$onClick($author$project$CounterTests$Increment)
					]),
				_List_fromArray(
					[
...
var $author$project$CounterTests$mainWithEvent = $elm$browser$Browser$sandbox(
	{init: 0, update: $author$project$CounterTests$updateWithEvent, view: $author$project$CounterTests$viewWithModel});
...
var $author$project$CounterTests$tests = A2(
				...
				[
					...
					function (_v0) {
						...
						return A2(
							...
							expectedModel,
							A2($author$project$CounterTests$updateWithEvent, $author$project$CounterTests$Increment, initialModel));
					})
				]))
		]));
var $author$project$Test$Generated$Main$main = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$author$project$Test$Runner$Node$check($author$project$CounterTests$mainWithEvent),
					$author$project$Test$Runner$Node$check($author$project$CounterTests$tests)
				]))
		]));
_Platform_export({'Test':{'Generated':{'Main':{'init':$author$project$Test$Generated$Main$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-11834.sock";
var net = require('net'),
